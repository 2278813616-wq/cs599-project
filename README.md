...
- 课程交付：报告源稿、PDF、架构图、流程图、数据流图、运行截图均放在 `docs/`。
...
- 源稿：`docs/CS599_大作业报告.md`
- 图表与截图：`docs/coursework_assets/`
- 测试摘要：`docs/coursework_assets/test_summary.txt`

姓名、学号目前仍为占位符，提交前需要替换后重新生成 PDF。
